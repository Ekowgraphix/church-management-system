...
<head>
    ...
    <title>Ministry Leader - {{ config('app.name') }}</title>
...
<body class="font-sans antialiased">
    ...
    <div class="flex min-h-screen relative">
        <!-- Sidebar -->
        <aside class="sidebar w-80 h-screen fixed left-0 top-0 z-40 flex flex-col overflow-hidden" id="sidebar">
            ...
            <div class="p-8 border-b border-white border-opacity-10 flex-shrink-0">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-green-300 font-black text-2xl tracking-tight">Ministry Leader</h2>
                        <p class="text-green-200 text-xs font-medium">Ministry Management</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-6 space-y-2 flex-1 sidebar-nav" style="overflow-y: scroll !important; overflow-x: hidden !important; max-height: calc(100vh - 250px); min-height: 400px;">
                <a href="{{ route('ministry-leader.dashboard') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.dashboard') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.dashboard') ? 'gradient-green' : 'bg-white/5' }} group-hover:gradient-green transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.members') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.members') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.members') ? 'gradient-blue' : 'bg-white/5' }} group-hover:gradient-blue transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.groups') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.groups') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.groups') ? 'gradient-purple' : 'bg-white/5' }} group-hover:gradient-purple transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.events') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.events') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.events') ? 'gradient-purple' : 'bg-white/5' }} group-hover:gradient-purple transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.prayer-requests') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.prayer-requests') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.prayer-requests') ? 'gradient-blue' : 'bg-white/5' }} group-hover:gradient-blue transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.reports') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.reports') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.reports') ? 'gradient-pink' : 'bg-white/5' }} group-hover:gradient-pink transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.communication') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.communication') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.communication') ? 'gradient-cyan' : 'bg-white/5' }} group-hover:gradient-cyan transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.ai-assistant') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.ai-assistant') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.ai-assistant') ? 'gradient-cyan' : 'bg-white/5' }} group-hover:gradient-cyan transition-all relative z-10">
                ...
                <a href="{{ route('ministry-leader.settings') }}" class="sidebar-item {{ request()->routeIs('ministry-leader.settings') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('ministry-leader.settings') ? 'gradient-orange' : 'bg-white/5' }} group-hover:gradient-orange transition-all relative z-10">
        ...
        <!-- Main Content -->
        <div class="flex-1 ml-80 lg:ml-80 ml-0 relative z-10 main-content">
            <!-- Top Bar -->
                ...
                <div class="flex items-center justify-between px-10 py-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs text-green-200">Ministry Leader</p>
                        </div>
