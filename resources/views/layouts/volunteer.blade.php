        ...
        <aside class="sidebar w-80 h-screen fixed left-0 top-0 z-40 flex flex-col overflow-hidden">
            ...
            <div class="p-8 border-b border-white border-opacity-10 flex-shrink-0">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-green-300 font-black text-2xl tracking-tight">Volunteer</h2>
                        <p class="text-green-200 text-xs font-medium">Your Service Dashboard</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-6 space-y-2 flex-1 sidebar-nav" style="overflow-y: scroll !important; overflow-x: hidden !important; max-height: calc(100vh - 250px); min-height: 400px;">
                <a href="{{ route('volunteer.dashboard') }}" class="sidebar-item {{ request()->routeIs('volunteer.dashboard') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.dashboard') ? 'gradient-green' : 'bg-white/5' }} group-hover:gradient-green transition-all relative z-10">
                ...
                <a href="{{ route('volunteer.events') }}" class="sidebar-item {{ request()->routeIs('volunteer.events') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.events') ? 'gradient-purple' : 'bg-white/5' }} group-hover:gradient-purple transition-all relative z-10">
                        <i class="fas fa-calendar-alt text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">Assigned Events</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('volunteer.tasks') }}" class="sidebar-item {{ request()->routeIs('volunteer.tasks') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.tasks') ? 'gradient-blue' : 'bg-white/5' }} group-hover:gradient-blue transition-all relative z-10">
                        <i class="fas fa-tasks text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">My Tasks</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('volunteer.team') }}" class="sidebar-item {{ request()->routeIs('volunteer.team') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.team') ? 'gradient-cyan' : 'bg-white/5' }} group-hover:gradient-cyan transition-all relative z-10">
                        <i class="fas fa-user-friends text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">My Team</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('volunteer.prayer') }}" class="sidebar-item {{ request()->routeIs('volunteer.prayer') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.prayer') ? 'gradient-purple' : 'bg-white/5' }} group-hover:gradient-purple transition-all relative z-10">
                        <i class="fas fa-praying-hands text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">Prayer</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('volunteer.ai-helper') }}" class="sidebar-item {{ request()->routeIs('volunteer.ai-helper') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.ai-helper') ? 'gradient-cyan' : 'bg-white/5' }} group-hover:gradient-cyan transition-all relative z-10">
                        <i class="fas fa-robot text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">AI Helper</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('volunteer.communication') }}" class="sidebar-item {{ request()->routeIs('volunteer.communication') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.communication') ? 'gradient-pink' : 'bg-white/5' }} group-hover:gradient-pink transition-all relative z-10">
                ...
                <a href="{{ route('volunteer.settings') }}" class="sidebar-item {{ request()->routeIs('volunteer.settings') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('volunteer.settings') ? 'gradient-orange' : 'bg-white/5' }} group-hover:gradient-orange transition-all relative z-10">
