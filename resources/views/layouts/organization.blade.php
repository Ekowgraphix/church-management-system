...
<head>
    ...
    <title>Organization - {{ config('app.name') }}</title>
...
<body class="font-sans antialiased">
        ...
        <aside class="sidebar" id="sidebar" w-80 h-screen fixed left-0 top-0 z-40 flex flex-col overflow-hidden">
            ...
            <div class="p-8 border-b border-white border-opacity-10 flex-shrink-0">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-green-300 font-black text-2xl tracking-tight">Organization</h2>
                        <p class="text-green-200 text-xs font-medium">Multi-Branch Administration</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-6 space-y-2 flex-1 sidebar-nav" style="overflow-y: scroll !important; overflow-x: hidden !important; max-height: calc(100vh - 250px); min-height: 400px;">
                <a href="{{ route('organization.dashboard') }}" class="sidebar-item {{ request()->routeIs('organization.dashboard') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.dashboard') ? 'gradient-green' : 'bg-white/5' }} group-hover:gradient-green transition-all relative z-10">
                ...
                <a href="{{ route('organization.branches') }}" class="sidebar-item {{ request()->routeIs('organization.branches') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.branches') ? 'gradient-blue' : 'bg-white/5' }} group-hover:gradient-blue transition-all relative z-10">
                        <i class="fas fa-building text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">Branches</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('organization.staff') }}" class="sidebar-item {{ request()->routeIs('organization.staff') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.staff') ? 'gradient-purple' : 'bg-white/5' }} group-hover:gradient-purple transition-all relative z-10">
                        <i class="fas fa-users-cog text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">Staff & Roles</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('organization.finance') }}" class="sidebar-item {{ request()->routeIs('organization.finance') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.finance') ? 'gradient-orange' : 'bg-white/5' }} group-hover:gradient-orange transition-all relative z-10">
                ...
                <a href="{{ route('organization.reports') }}" class="sidebar-item {{ request()->routeIs('organization.reports') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.reports') ? 'gradient-pink' : 'bg-white/5' }} group-hover:gradient-pink transition-all relative z-10">
                ...
                <a href="{{ route('organization.events') }}" class="sidebar-item {{ request()->routeIs('organization.events') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.events') ? 'gradient-purple' : 'bg-white/5' }} group-hover:gradient-purple transition-all relative z-10">
                ...
                <a href="{{ route('organization.ai-insights') }}" class="sidebar-item {{ request()->routeIs('organization.ai-insights') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.ai-insights') ? 'gradient-cyan' : 'bg-white/5' }} group-hover:gradient-cyan transition-all relative z-10">
                        <i class="fas fa-brain text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">AI Insights</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('organization.communication') }}" class="sidebar-item {{ request()->routeIs('organization.communication') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.communication') ? 'gradient-blue' : 'bg-white/5' }} group-hover:gradient-blue transition-all relative z-10">
                        <i class="fas fa-comments text-white"></i>
                    </div>
                    <span class="ml-4 font-semibold text-sm relative z-10">Communication</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-0 group-hover:opacity-100 transition-opacity relative z-10 text-green-300"></i>
                </a>
                
                <a href="{{ route('organization.settings') }}" class="sidebar-item {{ request()->routeIs('organization.settings') ? 'active' : '' }} flex items-center text-green-300 hover:text-green-200 px-6 py-4 rounded-2xl group relative z-10">
                    <div class="icon-box w-12 h-12 flex items-center justify-center rounded-xl {{ request()->routeIs('organization.settings') ? 'gradient-orange' : 'bg-white/5' }} group-hover:gradient-orange transition-all relative z-10">
        ...
        <div class="flex-1 main-content relative z-10">
                ...
                <div class="flex items-center justify-between px-10 py-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs text-green-200">Organization</p>
                        </div>
            ...
            <main class="animate-fade-in">
                <div class="max-w-[1920px] mx-auto px-8 py-8 space-y-6">
                    @if (session('success'))
                        <div class="glass-card border-l-4 border-green-500 px-6 py-5 rounded-2xl flex items-center space-x-4 shimmer">
                    ...
                    @if (session('error'))
                        <div class="glass-card border-l-4 border-red-500 px-6 py-5 rounded-2xl flex items-center space-x-4">
    ...
    <!-- Organization Portal JavaScript -->
    <script src="{{ asset('js/organization-portal.js') }}"></script>
</body>
</html>
